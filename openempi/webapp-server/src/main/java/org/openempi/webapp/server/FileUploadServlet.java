            ...
            try {
                ...
                for (FileItem item : items) {
                	...
                	if (item.isFormField())  {
                        ...
                        if (item.getFieldName().equals("entity")) {
                            name = new String(item.get());
                            isEntity = true;
                        }
                    	continue;
                    ...
                    if (uploadedFile.createNewFile()) {
                        ...
                        saveUploadFileEntry(name, fileName, isEntity, uploadedFile.getAbsolutePath());
                    } else {
...
//                            "Request contents type is not supported by the servlet.");
	...
	private void saveUploadFileEntry(String name, String filename, boolean isEntity, String absolutePath) throws IOException {
