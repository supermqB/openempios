...
{
	void initializeStore(Entity entity) throws InitializationException;
	...
	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    Record importRecord(Entity entity, Record record) throws ApplicationException;

    @Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    Set<Record> importRecords(Entity entity, Collection<Record> records) throws ApplicationException;

    @Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    Record updateRecord(Entity entity, Record record) throws ApplicationException;

	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    Record deleteRecord(Entity entity, Record record) throws ApplicationException;

	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    List<Record> deleteRecordByIdentifier(Entity entity, Identifier identifier) throws ApplicationException;

	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    Record removeRecord(Entity entity, Record record) throws ApplicationException;

	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    void mergeRecords(Entity entity, Identifier retiredIdentifier, Identifier survivingIdentifier)
            throws ApplicationException;
	
	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    RecordLink addRecordLink(RecordLink link) throws ApplicationException;

	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    RecordLink updateRecordLink(RecordLink link) throws ApplicationException;

    @Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    void removeRecordLink(RecordLink link) throws ApplicationException;
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    void linkAllRecordPairs(Entity entity) throws ApplicationException;
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, readOnly=false)
    void clearAllLinks(Entity entity);
	 ...
	 */
    void generateCustomFields(Entity entity) throws ApplicationException;

	void declareIntent(Entity entity, DataAccessIntent intent);
	
	boolean assignGlobalIdentifier(Entity entity) throws ApplicationException;
}
